...
fit5sig8=nnet1.fit(X,Y,model2$b1,model2$w1,model2$b2,model2$w2,"tanh","sigmoid","dtanh","cost.negll",lr=.1,max.its=150000)
fit5id8=nnet1.fit(X,Y,model2$b1,model2$w1,model2$b2,model2$w2,"sigmoid","sigmoid","dsigmoid","cost.negll",lr=.1,max.its=150000)
fit5soft8-nnet1.fit(X,Y,model2$b1,model2$w1,model2$b2,model2$w2,"relu","sigmoid","drelu","cost.negll",lr=.1,max.its=150000)
fit100sig8=nnet1.fit(X,Y,model3$b1,model3$w1,model3$b2,model3$w2,"tanh","sigmoid","dtanh","cost.negll",lr=.1,max.its=150000)
fit100id8=nnet1.fit(X,Y,model3$b1,model3$w1,model3$b2,model3$w2,"sigmoid","sigmoid","dsigmoid","cost.negll",lr=.1,max.its=150000)
fit100soft8-nnet1.fit(X,Y,model3$b1,model3$w1,model3$b2,model3$w2,"relu","sigmoid","drelu","cost.negll",lr=.1,max.its=150000)
...
s1101=nnet1.fit.batch(X,Y,b1,w1,b2,w2,"sigmoid","sigmoid","dsigmoid","cost.negll",32,lr=.01,100)
s1102=nnet1.fit.batch(X,Y,b1,w1,b2,w2,"sigmoid","sigmoid","dsigmoid","cost.negll",64,lr=.01,100)
s1103=nnet1.fit.batch(X,Y,b1,w1,b2,w2,"sigmoid","sigmoid","dsigmoid","cost.negll",128,lr=.01,100)
```
