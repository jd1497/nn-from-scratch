...
ph8a = NULL
for (i in 1:100){
  test_accu=(accuracy(modx,yval,step8[[i]]$b,step8[[i]]$w))
  test_accu1=(accuracy(modx,yval,step8a[[i]]$b,step8a[[i]]$w))
  ph8=append(ph8,test_accu)
  ph8a=append(ph8a,test_accu1)
}
plot(ph8,type="l",xlab="Number of Iterations",ylab="Accuracy",main="Performance history on Learning Rate=0.1")
plot(ph8a,type="l",xlab="Number of Iterations",ylab="Accuracy",main="Performance history on Learning Rate=0.01")
```
